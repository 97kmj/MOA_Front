            ...
            <div className={styles.body}>
                ...
                <div className={styles.registform}>
                    ...
                    <div className={styles.imgBox}>
                        <img
                            src={profileImg ? profileImg : "https://img.icons8.com/?size=150&id=114064&format=png&color=B39C59"}/>
                    </div>
                    <div className={styles.imgUploadbox}>
                        <label for="profileImage">프로필 사진 선택</label><input type="file" id="profileImage"
                    ...
                    <div>
                        <div className={styles.registArtistCareerOutForm}>
                            <h4 style={{textAlign: "left"}}>작가 이력</h4>
                            <div className={""}>
                                <ReactQuill
                                    value={registArtistInfo.artistCareer}
                        ...
                        <div>
                            ...
                            <div className={""}>
                                <ReactQuill
                                    value={registArtistInfo.artistNote}
