...
import styles from '../../css/mypage/side.module.css';
    ...
    <div className={styles.snbArea}>
      ...
      <nav className={styles.snb}>
        <div className={styles.snbList}>
          <strong className={styles.snbTitle}>
            <svg className={styles.cartIcon} xmlns="http://www.w3.org/2000/svg" height="21px" viewBox="0 -960 960 960" width="21px" fill="#5f6368">
        ...
        <div className={styles.snbList}>
          <strong className={styles.snbTitle}>
            <svg className={styles.cartIcon} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
        ...
        <div className={styles.snbList}>
          <strong className={styles.snbTitle}>
            <svg className={styles.cartIcon} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368">
